 ...
 */
interface DynamoDBInitialPosition {
    InitialPositionInStream getPosition();
}

public class DynamoDBInitialPositions {
    public static class Latest implements DynamoDBInitialPosition, Serializable {
        public Latest() {}
    ...
    public static class TrimHorizon implements DynamoDBInitialPosition, Serializable {
        public TrimHorizon() {}
    ...
    public static class AtTimestamp implements DynamoDBInitialPosition, Serializable {
     ...
     */
    public static DynamoDBInitialPosition fromKinesisInitialPosition(
